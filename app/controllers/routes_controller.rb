class RoutesController < ApplicationController
  ...
  def route_params
    params.require(:route).permit(:make_private, :starting_system, :starting_dock, :ending_system, :ending_dock, :commodity, :buy_price, :sell_price, :jump_distance, :dock_distance)
  end
